...
export default function InstantAds() {
  return (
    <div className="mx-auto max-w-[100%] w-[100%] sm:mt-[150px] mt-[50px] sm:px-[0px] px-[0px] ">
      ...
      <div className="sm:mt-[70px] mt-[20px] grid sm:grid-cols-3 grid-cols-none gap-4 sm:w-[1100px] w-[100%] justify-center place-items-center max-w-[100%] mx-auto ">
        <div className="max-w-[100%] w-[358px] my-[5px] sm:my-[0px] sm:px-[0px] px-[10px] linear-bg mx-auto">
          <AdsCompo
            title="Facebook Ads"
