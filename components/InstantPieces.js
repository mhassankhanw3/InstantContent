  ...
  return (
    <div className="mt-[150px]">
      ...
      <div className="mt-[70px] flex items-center flex-wrap justify-center max-w-full mx-auto ">
        ...
        <div className="sm:my-[0px] flex flex-wrap items-center justify-center max-w-[100%] w-[75%] mx-auto border border-white">
        ...
        <div className="sm:my-[0px] flex flex-wrap items-center justify-start max-w-[100%] w-[77.5%] p-0 mx-auto border border-white">
          <div className="max-w-full my-[5px] sm:my-[12px] sm:mx-[17px] linear-bg">
            <AdsCompo
